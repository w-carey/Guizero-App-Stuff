...
guizerostuff.uselessbox(SIGNUP_main, "fill", 5)
SIGNUP_usertype = guizerostuff.createcheckbox(SIGNUP_main, "USER TYPE", None)
...
ordermenu = guizerostuff.createminimenu(infopanel)
createreview = guizerostuff.createminimenu(infopanel)
guizerostuff.changeminimenu(ordermenu)
guizerostuff.uselessbox(leftpanel, "fill", 25)
MENU_createorderbutton = guizerostuff.createbutton(leftpanel, 125, 25, "ORDER ITEM", lambda:[updateproductlist(),guizerostuff.changeminimenu(ordermenu)])
guizerostuff.uselessbox(leftpanel, "fill", 10)
MENU_createreviewbutton = guizerostuff.createbutton(leftpanel, 125, 25, "CREATE REVIEW", lambda:guizerostuff.changeminimenu(createreview))
#ordermenustuff
productlist = ListBox(ordermenu,width=125, height="fill", align="left")
orderinfobox = Box(ordermenu, width="fill", height="fill", align="right")
orderinfoproduct = TextBox(orderinfobox, width="fill", height=5, text="", multiline=True)
orderinforeviews = TextBox(orderinfobox, width="fill", height=14, text="", multiline=True)
orderbuttonactual = guizerostuff.createbutton(orderinfobox, 125, 25, "SUBMIT ORDER", None)
#
###
staffstuff.hide()
######
